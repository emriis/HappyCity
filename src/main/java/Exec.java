...
public class Exec {
	...
	public static void main(String[] args) {
		...
		List<Building> starterDeck = deckManager.getGameStarterDeck(2);
		...
		List<Building> buildingDeck2 = deckManager.getGameMediumCostBuildingsDeck();
		...
		List<Building> specialDeck = deckManager.getGameSpecialBuildingsDeck();
